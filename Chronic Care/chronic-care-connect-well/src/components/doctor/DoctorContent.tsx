        ...
        <div className="space-y-3">
          ...
          <DialogContent className="bg-gray-800 border-gray-700 text-gray-100 max-w-2xl">
            ...
            <DialogDescription className="sr-only">Provide prescription details and guidance for the patient.</DialogDescription>
                      ...
                      <div className="space-y-3">
                        <div>
                          <Label className="text-gray-300">Medicine name *</Label>
                          <Select
                            value={form.medicineName}
                            onValueChange={(value) => {
                              // Find the medicine to get its label
                          ...
                          <p className="text-xs text-gray-400 mt-1">Search or scroll to find the medication</p>
                        </div>
                        <div>
