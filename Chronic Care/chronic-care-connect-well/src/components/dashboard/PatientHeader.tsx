...
export default function PatientHeader() {
	...
	return (
		<header className="bg-gray-800 border-b border-gray-700 p-3 md:p-4 flex items-center justify-between sticky top-0 z-10">
			...
			<div className="flex items-center gap-2 md:gap-3">
				...
				<div className="text-gray-300 text-xs md:text-sm truncate max-w-[120px] md:max-w-none">
